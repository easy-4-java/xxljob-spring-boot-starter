...
|----------|-----------------|-------------|-----|--------------|
| `2.3.x` | `2.3.x.{date}-SNAPSHOT` | 2.3.12.RELEASE | 8 | 2.5.0 |
| `2.4.x` | `2.4.x.{date}-SNAPSHOT` | 2.4.13 | 8 | 2.5.0 |
| `2.5.x` | `2.5.x.{date}-SNAPSHOT` | 2.5.15 | 8 | 2.5.0 |
| `2.6.x` | `2.6.x.{date}-SNAPSHOT` | 2.6.15 | 8 | 2.5.0 |
| `2.7.x` | `2.7.x.20260624-SNAPSHOT` | 2.7.18 | 8 | 2.5.0 |
...
| `3.3.x` | `3.3.x.{date}-SNAPSHOT` | 3.3.13 | 17 | 3.3.2 |
| `3.4.x` | `3.4.x.{date}-SNAPSHOT` | 3.4.13 | 17 | 3.4.2 |
| `3.5.x` | `3.5.x.{date}-SNAPSHOT` | 3.5.16 | 17 | 3.4.2 |
| `4.0.x` | `4.0.x.{date}-SNAPSHOT` | 4.0.7 | 21 | 3.4.2 |
| `4.1.x` | `4.1.x.{date}-SNAPSHOT` | 4.1.0 | 21 | 3.4.2 |
